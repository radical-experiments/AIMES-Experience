...
if __name__ == '__main__':
    ...
    if True:
        ...
        # Launch the pilot.
        pilot = pmgr.submit_pilots([pdesc, pdesc, pdesc, pdesc])
        ...
        for i in range(0, n):
            ...
            if i % 2: cud.executable = 'date'
            else    : cud.executable = 'data'
        ...
        report.info('\n')
        for unit in units:
            report.plain('  * %s: %s, exit: %3s' % (unit.uid, unit.state[:4], unit.exit_code))
            report.ok('>>ok\n')
